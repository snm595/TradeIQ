...
export default function MarketPulseBar({ ticker, analysis }) {
    ...
    <section className="panel px-4 py-3 flex flex-wrap items-center justify-between gap-3">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-200">{ticker} • {regime}</p>
        </div>
      </div>
      <div className="flex items-center gap-5 text-sm">
        <span className="flex items-center gap-2 text-slate-300"><Zap className="w-4 h-4 text-sky-300" /> AI pulse synchronized</span>
